        ...
        <div x-show="isOpen" x-transition:enter="ease-out duration-200"
            ...
            <div class="relative">
                <div class="absolute h-full right-5 flex items-center">
                    <svg class="animate-spin h-5 w-5 text-white d-none" xmlns="http://www.w3.org/2000/svg" fill="none"
                         viewBox="0 0 24 24" wire:loading.delay wire:loading.class.remove="d-none">
