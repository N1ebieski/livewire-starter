...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`,
                ...
                vAttributes = vAttributes.map((attribute) => {
                    if (
                        staticAttributes.find(
                            (attr2) => attr2.name === attribute.name
                        )
                    ) {
                        return {
            ...
            let reference = effect(() => {
                ...
                if (firstRun) {
                    ...
                    if (outerHashLatest !== outerHash) {
                        ...
                        outerSet(
                            JSON.parse(
                                innerHashLatest != null ? innerHashLatest : null
                            )
                        );
                        outer = inner;
                    }
        ...
        directive2("effect", (el, { expression }, { effect: effect3 }) =>
        ...
        var __toModule = (module2) => {
            return __exportStar(
                __markAsModule(
                    __defProp2(
                        module2 != null
                            ? __create2(__getProtoOf2(module2))
                            : {},
                        "default",
...
var require_module_cjs4 = __commonJS({
    "../../../../usr/local/lib/node_modules/@alpinejs/persist/dist/module.cjs.js"(
        ...
        function src_default(Alpine18) {
            ...
            Object.defineProperty(Alpine18, "$persist", {
                get: () => persist2(),
            });
    ...
    "../alpine/packages/navigate/dist/module.cjs.js"(exports, module) {
            ...
            "node_modules/nprogress/nprogress.js"(exports2, module2) {
                (function (root, factory) {
                    ...
                    NProgress2.trickle = function () {
                        return NProgress2.inc(
                            Math.random() * Settings.trickleRate
                        );
                    };
                    (function () {
                        var initial = 0,
        ...
        function fromSessionStorage(timestamp) {
            let state = JSON.parse(
                sessionStorage.getItem("alpine:" + timestamp)
            );
            return state;
        }
        ...
        function restoreScrollPosition() {
            let scroll = (el) => {
                el.scrollTo(
                    Number(el.getAttribute("data-scroll-x")),
                    Number(el.getAttribute("data-scroll-y"))
                );
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`,
    ...
    `;
        ...
        function swapCurrentPageWithNewHtml(html, andThen) {
            ...
            let oldBodyScriptTagHashes = Array.from(
                document.body.querySelectorAll("script")
            ).map((i) => simpleHash(i.outerHTML));
        ...
        function mergeNewHead(newHead) {
            let headChildrenHtmlLookup = Array.from(document.head.children).map(
                (i) => i.outerHTML
            );
        ...
        function fireEventForOtherLibariesToHookInto(init = false) {
            document.dispatchEvent(
                new CustomEvent("alpine:navigated", {
                    bubbles: true,
                    detail: { init },
                })
            );
            ...
            let buildQueryStringEntries = (
                ...
                Object.entries(data2).forEach(([iKey, iValue]) => {
                    ...
                    if (!isObjecty2(iValue)) {
                        entries2[key] = encodeURIComponent(iValue).replaceAll(
                            "%20",
                            "+"
                        );
                    } else {
            ...
            function patchChildren(from2, to) {
                ...
                while (currentTo) {
                    ...
                    let isIf = (node) =>
                        node &&
                        node.nodeType === 8 &&
                        node.textContent === " __BLOCK__ ";
                    let isEnd = (node) =>
                        node &&
                        node.nodeType === 8 &&
                        node.textContent === " __ENDBLOCK__ ";
...
var require_module_cjs9 = __commonJS({
    "../alpine/packages/mask/dist/module.cjs.js"(exports, module) {
        ...
        function formatMoney(input, delimiter = ".", thousands, precision = 2) {
            ...
            thousands =
                thousands != null ? thousands : delimiter === "," ? "." : ",";
...
// js/request.js
var updateUri =
    document.querySelector("[data-uri]")?.getAttribute("data-uri") ??
...
function bundleMultipleRequestsTogetherIfTheyHappenWithinFiveMsOfEachOther(
    callback
) {
...
var Component = class {
    constructor(el) {
        ...
        if (!this.snapshot) {
            throw (
                new `Snapshot missing on Livewire component with id: `() +
                this.id
            );
        }
...
on("component.init", ({ component }) => {
    ...
    Object.entries(queryString).forEach(([key, value]) => {
        let { name, as, use, alwaysShow } = normalizeQueryStringEntry(
            key,
            value
        );
        if (!as) as = name;
        let initialValue = dataGet(component.ephemeral, name);
        let { initial, replace, push, pop } = (0, import_history2.track)(
            as,
            initialValue,
            alwaysShow
        );
    ...
    import_alpinejs9.default.morph(el, to, {
        ...
        added: (el2) => {
            ...
            if (closestComponentId === component.id) {
                ...
                if (
                    message.fingerprint &&
                    closestComponentId == message.fingerprint.id
                ) {
                    data = {
        ...
        let cleanupBinding = import_alpinejs11.default.bind(el, {
            [attribute](e) {
                callAndClearComponentDebounces(component, () => {
                    import_alpinejs11.default.evaluate(
                        el,
...
import_alpinejs12.default.interceptInit(
    import_alpinejs12.default.skipDuringClone((el) => {
...
function triggerComponentRequest(el, directive2) {
    import_alpinejs15.default.evaluate(
        el,
...
export { export_Alpine as Alpine, Livewire };
/*!
 * focus-trap 6.6.1
